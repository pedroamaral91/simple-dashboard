...
export const authCreators = {
  ...
  signInRequest: (email: String, password: String) => Action(AuthTypes.SIGN_IN_REQUEST, { email, password }),
  signInSuccess: (token: string, user: UserState) => Action(AuthTypes.SIGN_IN_SUCCESS, { token, user }),
